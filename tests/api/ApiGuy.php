...
class ApiGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function haveInCollection($collection, $data) {
        $this->scenario->addStep(new \Codeception\Step\Action('haveInCollection', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function canSeeInCollection($collection, $criteria = null) {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeInCollection', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeInCollection($collection, $criteria = null) {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeInCollection', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    * Conditional Assertion: Test won't be stopped on fail
    ...
    public function cantSeeInCollection($collection, $criteria = null) {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('dontSeeInCollection', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function dontSeeInCollection($collection, $criteria = null) {
        $this->scenario->addStep(new \Codeception\Step\Assertion('dontSeeInCollection', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function grabFromCollection($collection, $criteria = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('grabFromCollection', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
