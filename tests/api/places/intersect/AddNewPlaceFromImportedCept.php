...
$I->sendPOST('service/import/place-intersect', json_encode(array('source'=>'vesta', 'id' => '29', 'place' => null)));
...
$I->seeResponseContainsJson(
    array(
        ...
        '_links' => array(
            'self' => array(
                'href' => 'http://cargo.dev/api/service/import/place-intersect/vesta-29',
            ),
        ),
    )
);
...
$I->seeInCollection('externalPlace', array('source' => 'vesta', 'id' => '29', 'link' => array('$ne' => null)));
